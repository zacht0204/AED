...
public class Vender extends JDialog implements ActionListener, KeyListener {
	 ...
	 */
	public Vender() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Vender.class.getResource("/imagenes/favicon.png")));
		setTitle(" VENTAS");
		...
		btnVender.setIcon(new ImageIcon(Vender.class.getResource("/imagenes/money_bag.png")));
		...
		btnCerrar.setIcon(new ImageIcon(Vender.class.getResource("/imagenes/Salida2.png")));
		...
		btnNewButton.setIcon(new ImageIcon(Vender.class.getResource("/imagenes/save.png")));
		btnNewButton.setBounds(269, 460, 107, 30);
		getContentPane().add(btnNewButton);
		
		lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(Vender.class.getResource("/imagenes/vender.png")));
