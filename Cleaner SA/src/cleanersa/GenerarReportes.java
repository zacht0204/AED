...
public class GenerarReportes extends JDialog implements ActionListener, ItemListener {
	...
	public GenerarReportes() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(GenerarReportes.class.getResource("/imagenes/favicon.png")));
		...
		btnCerrar.setIcon(new ImageIcon(GenerarReportes.class.getResource("/imagenes/Salida2.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(GenerarReportes.class.getResource("/imagenes/GENERAR.png")));
