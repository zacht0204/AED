...
public class GenerarReportes2 extends JDialog implements ActionListener, ItemListener {
	 ...
	 * Create the dialog.
	 */
	public GenerarReportes2() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(GenerarReportes2.class.getResource("/imagenes/favicon.png")));
		setTitle(" GENERAR REPORTE-[Vendedor]");
		...
		btnCerrar.setIcon(new ImageIcon(GenerarReportes2.class.getResource("/imagenes/Salida2.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(GenerarReportes2.class.getResource("/imagenes/GENERAR.png")));
